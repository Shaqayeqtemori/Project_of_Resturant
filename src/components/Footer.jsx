function Footer() {
    return (
        <footer className="bg-orange-700 text-gray-300 pt-12 mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <button
                                type="button"
                                className="absolute top-1 right-1 bg-orange-500 text-white px-5 py-2 rounded hover:bg-orange-700 transition"
                            >
                                SignUp
                            </button>
                        </div>
            ...
            {/* Copyright Section */}
            <div className="bg-orange-900 py-6 text-sm">
                <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                    <div className="mb-3 md:mb-0">
                        &copy; <a className="underline hover:text-white" href="#">Your Site Name</a>, All Right Reserved.
                        <br />
                        Designed By <a className="underline hover:text-white" href="https://htmlcodex.com">HTML Codex</a> | 
                        Distributed By <a className="underline hover:text-white" href="https://themewagon.com">ThemeWagon</a>
                    </div>
                    <div className="space-x-4">
                        <a href="#" className="hover:underline hover:text-white">Home</a>
                        <a href="#" className="hover:underline hover:text-white">Cookies</a>
                        <a href="#" className="hover:underline hover:text-white">Help</a>
                        <a href="#" className="hover:underline hover:text-white">FAQs</a>
                    </div>
                </div>
            </div>
        </footer>
