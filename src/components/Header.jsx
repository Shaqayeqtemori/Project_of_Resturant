            ...
            <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <nav className="hidden md:flex space-x-6 items-center">
                    ...
                    <div className="relative group">
                        <button className="text-gray-700 hover:text-blue-600 font-medium">Pages</button>
                    ...
                    <Link to="/join" className="ml-4 px-5 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Join Now <i className="fas fa-arrow-right ml-2"></i></Link>
                </nav>
